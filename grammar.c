...
int** initialiseRules(int **rules)
{
    ...
    rules[INT_LIST][semicol] = 68;
    rules[INT_LIST][cb_cl] = 68;
    ...
    rules[INT_LIST_LIST][semicol] = 32;
    rules[INT_LIST_LIST][cb_cl] = 32;
    rules[INT_LIST_LIST_DASH][cb_cl] = 34;
    rules[INT_LIST_LIST_DASH][semicol] = 33;
    rules[INT_VAR_LIST][num] = 35;
    rules[INT_VAR_LIST][semicol] = 35;
    rules[INT_VAR_LIST][cb_cl] = 35;
